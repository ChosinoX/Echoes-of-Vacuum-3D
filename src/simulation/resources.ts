...
export const COSTS:Record<BuildingType,Partial<Record<ResourceKey,number>>>={command:{metal:0},solar:{metal:45,crystals:4},oxygen:{metal:70,crystals:8},hydroponics:{metal:90,water:8},mining:{metal:110,crystals:6},storage:{metal:55}};
export const LABELS:Record<BuildingType,string>={command:'Command Center',solar:'Solar Plant',oxygen:'Oxygen Generator',hydroponics:'Hydroponics',mining:'Mining Complex',storage:'Storage'};
