...
if(w.state==='walking'){if(!w.mover.target)w.state='working';continue}
if(w.state==='working'){w.work+=dt;site.progress=Math.min(1,site.progress+dt*.035);if(site.progress>=1)sendHome(w)}
}}