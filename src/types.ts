...
export type BuildingType='command'|'solar'|'oxygen'|'hydroponics'|'mining'|'storage';
export interface BuildingData{ id:string; type:BuildingType; position:[number,number,number]; rotation:number; progress:number }
